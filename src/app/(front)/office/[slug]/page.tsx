            ...
            <div className="flex flex-col gap-[30px]">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="#"
                    aria-label="Call Masayoshi"
                    title="Call Masayoshi"
                  >
                    <Image
                  ...
                  <a
                    href="#"
                    aria-label="Chat with Masayoshi"
                    title="Chat with Masayoshi"
                  >
                    <Image
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="#"
                    aria-label="Call Fuji Ovina"
                    title="Call Fuji Ovina"
                  >
                    <Image
                      src="/assets/images/icons/call-green.svg"
                      className="w-10 h-10"
                  ...
                  <a
                    href="#"
                    aria-label="Chat with Fuji Ovina"
                    title="Chat with Fuji Ovina"
                  >
                    <Image
                      src="/assets/images/icons/chat-green.svg"
                      className="w-10 h-10"
